               ...
               <nav class="navbar navbar-expand-lg custom_nav-container ">
                  ...
                  <div class="collapse navbar-collapse" id="navbarSupportedContent" style="font-size:13px; margin-left:5vw;">
                     <ul class="navbar-nav">
                        ...
                        @else
                        <li class="nav-item">
                           <a class="btn btn-primary" href="{{ route('login') }}" style = "margin-right: 1.5vw; font-size:13px;">Login</a>
                        </li>
                        <li class="nav-item">
                           <a class="btn btn-success" href="{{ route('register') }}" style = "font-size:13px;">Register</a>
                        </li>
                        @endauth
                        @endif
                     </ul>

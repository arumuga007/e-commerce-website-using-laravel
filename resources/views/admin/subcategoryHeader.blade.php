<nav class="navbar p-0 fixed-top d-flex flex-row">
          ...
          <div class="navbar-menu-wrapper flex-grow d-flex align-items-stretch">
            ...
            <ul class="navbar-nav w-100">
              <li class="nav-item w-100">
                <form class="nav-link mt-2 mt-md-0 d-none d-lg-flex search" method="get" action="{{url('search-subcategory')}}" id='search-form'>
                    @csrf
                  <input type="text" class="form-control" placeholder="Search subcategory" name="searchValue" id="search-inputField" style="color: white;">
                </form>
              </li>
            </ul>
            <ul class="navbar-nav navbar-nav-right">
              <li class="nav-item dropdown d-none d-lg-block">
                ...
                <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="createbuttonDropdown">
                  <h6 class="p-3 mb-0">Quick Links</h6>
                  ...
                  <div class="dropdown-divider"></div>
                  <a class="dropdown-item preview-item" href="{{url('redirect')}}">
                    <div class="preview-thumbnail">
                      <div class="preview-icon bg-dark rounded-circle">
                    ...
                    <div class="preview-item-content">
                      <p class="preview-subject ellipsis mb-1">Go Back</p>
                    </div>
                  </a>
              </li>
        ...
        <script>
            ...
            document.getElementById('search-inputField').addEventListener('keypress', function(event) {
                consol.log('key event called');
                if(event.key == 'Enter') {

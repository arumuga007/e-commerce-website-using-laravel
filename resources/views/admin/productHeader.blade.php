          ...
          <div class="navbar-menu-wrapper flex-grow d-flex align-items-stretch">
            ...
            <ul class="navbar-nav w-100">
              <li class="nav-item w-100">
                <form class="nav-link mt-2 mt-md-0 d-none d-lg-flex search" method="post" action="{{url('search-product')}}" id='search-form'>
                    @csrf
                  <input type="text" class="form-control" placeholder="Search product" name="productName" id="search-inputField" style="color: white;">
                </form>
              </li>
            </ul>
